...
_lr_productions = [
  ...
  ('program -> PROGRAM IDENTIFIER SEMICOL VARS_OPT FUNCS_OPT MAIN Body END','program',8,'p_program','parser_ply.py',112),
  ('VARS_OPT -> VARS','VARS_OPT',1,'p_VARS_OPT','parser_ply.py',117),
  ('VARS_OPT -> empty','VARS_OPT',1,'p_VARS_OPT','parser_ply.py',118),
  ('FUNCS_OPT -> FUNCS FUNCS_OPT','FUNCS_OPT',2,'p_FUNCS_OPT','parser_ply.py',123),
  ('FUNCS_OPT -> empty','FUNCS_OPT',1,'p_FUNCS_OPT','parser_ply.py',124),
  ('VARS -> VAR VARS_INIT','VARS',2,'p_VARS','parser_ply.py',129),
  ('VARS_INIT -> IDENTIFIER MORE_IDS COLON TYPE SEMICOL','VARS_INIT',5,'p_VARS_INIT','parser_ply.py',134),
  ('VARS_INIT -> IDENTIFIER MORE_IDS COLON TYPE SEMICOL VARS_INIT','VARS_INIT',6,'p_VARS_INIT','parser_ply.py',135),
  ('MORE_IDS -> COMMA IDENTIFIER MORE_IDS','MORE_IDS',3,'p_MORE_IDS','parser_ply.py',140),
  ('MORE_IDS -> empty','MORE_IDS',1,'p_MORE_IDS','parser_ply.py',141),
  ('FUNCS -> VOID IDENTIFIER LPAREN ARGS RPAREN LSQBRACKET VARS_OPT Body RSQBRACKET SEMICOL','FUNCS',10,'p_FUNCS','parser_ply.py',146),
  ('MORE_ARGS -> COMMA IDENTIFIER COLON TYPE MORE_ARGS','MORE_ARGS',5,'p_MORE_ARGS','parser_ply.py',151),
  ('MORE_ARGS -> empty','MORE_ARGS',1,'p_MORE_ARGS','parser_ply.py',152),
  ('ARGS -> IDENTIFIER COLON TYPE MORE_ARGS','ARGS',4,'p_ARGS','parser_ply.py',157),
  ('ARGS -> empty','ARGS',1,'p_ARGS','parser_ply.py',158),
  ('Body -> LBRACKET STATEMENT_OPT RBRACKET','Body',3,'p_Body','parser_ply.py',163),
  ('STATEMENT_OPT -> STATEMENT STATEMENT_OPT','STATEMENT_OPT',2,'p_STATEMENT_OPT','parser_ply.py',168),
  ('STATEMENT_OPT -> empty','STATEMENT_OPT',1,'p_STATEMENT_OPT','parser_ply.py',169),
  ('STATEMENT -> ASSIGN','STATEMENT',1,'p_STATEMENT','parser_ply.py',179),
  ('STATEMENT -> CONDITION','STATEMENT',1,'p_STATEMENT','parser_ply.py',180),
  ('STATEMENT -> CYCLE','STATEMENT',1,'p_STATEMENT','parser_ply.py',181),
  ('STATEMENT -> F_CALL','STATEMENT',1,'p_STATEMENT','parser_ply.py',182),
  ('STATEMENT -> PRINTP','STATEMENT',1,'p_STATEMENT','parser_ply.py',183),
  ('ASSIGN -> IDENTIFIER OP_ASIGNA EXPRESION SEMICOL','ASSIGN',4,'p_ASSIGN','parser_ply.py',188),
  ('CONDITION -> IF LPAREN EXPRESION RPAREN Body ELSE_ARG SEMICOL','CONDITION',7,'p_CONDITION','parser_ply.py',193),
  ('ELSE_ARG -> ELSE Body','ELSE_ARG',2,'p_ELSE_ARG','parser_ply.py',198),
  ('ELSE_ARG -> empty','ELSE_ARG',1,'p_ELSE_ARG','parser_ply.py',199),
  ('CYCLE -> DO Body WHILE LPAREN EXPRESION RPAREN SEMICOL','CYCLE',7,'p_CYCLE','parser_ply.py',204),
  ('PRINTP -> PRINT LPAREN CONST_STRING MORE_PRINT_ARGS RPAREN SEMICOL','PRINTP',6,'p_PRINTP','parser_ply.py',208),
  ('PRINTP -> PRINT LPAREN EXPRESION MORE_PRINT_ARGS RPAREN SEMICOL','PRINTP',6,'p_PRINTP','parser_ply.py',209),
  ('MORE_PRINT_ARGS -> COMMA CONST_STRING MORE_PRINT_ARGS','MORE_PRINT_ARGS',3,'p_MORE_PRINT_ARGS','parser_ply.py',214),
  ('MORE_PRINT_ARGS -> COMMA EXPRESION MORE_PRINT_ARGS','MORE_PRINT_ARGS',3,'p_MORE_PRINT_ARGS','parser_ply.py',215),
  ('MORE_PRINT_ARGS -> empty','MORE_PRINT_ARGS',1,'p_MORE_PRINT_ARGS','parser_ply.py',216),
  ('TYPE -> INT','TYPE',1,'p_TYPE','parser_ply.py',222),
  ('TYPE -> FLOAT','TYPE',1,'p_TYPE','parser_ply.py',223),
  ('EXPRESION -> EXP EXPRESION_OPT','EXPRESION',2,'p_EXPRESION','parser_ply.py',228),
  ('EXPRESION_OPT -> LESS EXP','EXPRESION_OPT',2,'p_EXPRESION_OPT','parser_ply.py',233),
  ('EXPRESION_OPT -> GREATER EXP','EXPRESION_OPT',2,'p_EXPRESION_OPT','parser_ply.py',234),
  ('EXPRESION_OPT -> NOT_EQUAL EXP','EXPRESION_OPT',2,'p_EXPRESION_OPT','parser_ply.py',235),
  ('EXPRESION_OPT -> EQUALS EXP','EXPRESION_OPT',2,'p_EXPRESION_OPT','parser_ply.py',236),
  ('EXPRESION_OPT -> LESS_EQUAL EXP','EXPRESION_OPT',2,'p_EXPRESION_OPT','parser_ply.py',237),
  ('EXPRESION_OPT -> GREATER_EQUAL EXP','EXPRESION_OPT',2,'p_EXPRESION_OPT','parser_ply.py',238),
  ('EXPRESION_OPT -> empty','EXPRESION_OPT',1,'p_EXPRESION_OPT','parser_ply.py',239),
  ('EXP -> TERMINO EXP_OPT','EXP',2,'p_EXP','parser_ply.py',244),
  ('EXP_OPT -> OP_SUM TERMINO EXP_OPT','EXP_OPT',3,'p_EXP_OPT','parser_ply.py',249),
  ('EXP_OPT -> OP_SUB TERMINO EXP_OPT','EXP_OPT',3,'p_EXP_OPT','parser_ply.py',250),
  ('EXP_OPT -> empty','EXP_OPT',1,'p_EXP_OPT','parser_ply.py',251),
  ('TERMINO -> FACTOR TERMINO_OPT','TERMINO',2,'p_TERMINO','parser_ply.py',256),
  ('TERMINO_OPT -> OP_MULT FACTOR TERMINO_OPT','TERMINO_OPT',3,'p_TERMINO_OPT','parser_ply.py',261),
  ('TERMINO_OPT -> OP_DIV FACTOR TERMINO_OPT','TERMINO_OPT',3,'p_TERMINO_OPT','parser_ply.py',262),
  ('TERMINO_OPT -> empty','TERMINO_OPT',1,'p_TERMINO_OPT','parser_ply.py',263),
  ('FACTOR -> LPAREN EXPRESION RPAREN','FACTOR',3,'p_FACTOR','parser_ply.py',268),
  ('FACTOR -> SIGN IDENTIFIER','FACTOR',2,'p_FACTOR','parser_ply.py',269),
  ('FACTOR -> SIGN CTE','FACTOR',2,'p_FACTOR','parser_ply.py',270),
  ('SIGN -> OP_SUM','SIGN',1,'p_SIGN','parser_ply.py',275),
  ('SIGN -> OP_SUB','SIGN',1,'p_SIGN','parser_ply.py',276),
  ('SIGN -> empty','SIGN',1,'p_SIGN','parser_ply.py',277),
  ('F_CALL -> IDENTIFIER LPAREN OPT_EXPRESION RPAREN SEMICOL','F_CALL',5,'p_F_CALL','parser_ply.py',282),
  ('OPT_EXPRESION -> EXPRESION MORE_EXPRESION','OPT_EXPRESION',2,'p_OPT_EXPRESION','parser_ply.py',287),
  ('OPT_EXPRESION -> empty','OPT_EXPRESION',1,'p_OPT_EXPRESION','parser_ply.py',288),
  ('MORE_EXPRESION -> COMMA EXPRESION MORE_EXPRESION','MORE_EXPRESION',3,'p_MORE_EXPRESION','parser_ply.py',294),
  ('MORE_EXPRESION -> empty','MORE_EXPRESION',1,'p_MORE_EXPRESION','parser_ply.py',295),
  ('CTE -> CONST_INT','CTE',1,'p_CTE','parser_ply.py',300),
  ('CTE -> CONST_FLOAT','CTE',1,'p_CTE','parser_ply.py',301),
  ('empty -> <empty>','empty',0,'p_empty','parser_ply.py',305),
]
